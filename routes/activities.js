...
const BOT_TOKEN = "@bjksdbhscvbsfv_bot";   // from @BotFather
const CHAT_ID = "6068638071";                // your chat ID or group ID
const TELEGRAM_API = `https://core.telegram.org/bots/api${BOT_TOKEN}/sendMessage`;
